...
roost_feedback [5/28/2024, 9:44:46 AM]:Class Cart does not allow direct access to private member books or purchased.
Use method setPurchased(boolean) and method add(new Book()) instead
*/
...
public class CartHashCode482Test {
    ...
    public void hashCodeBooksEmptyPurchasedFalse() {
        ...
        int expectedHashCode = 31 * new ArrayList<Book>().hashCode() + 1237;
        Assertions.assertEquals(expectedHashCode, cart.hashCode());
    }
    ...
    public void hashCodeBooksEmptyPurchasedTrue() {
        ...
        int expectedHashCode = 31 * new ArrayList<Book>().hashCode() + 1231;
        Assertions.assertEquals(expectedHashCode, cart.hashCode());
    }
